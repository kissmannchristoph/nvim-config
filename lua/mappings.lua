...
keymap.set("n", "<Tab>o", "printf('m`%so<ESC>``', v:count1)", {
  expr = true,
...
keymap.set("n", "<leader><Tab>", "<cmd>StripTrailingWhitespace<cr>", { desc = "remove trailing space" })
...
keymap.set("n", "<F1>", "<cmd>NvimTreeToggle<cr>")
